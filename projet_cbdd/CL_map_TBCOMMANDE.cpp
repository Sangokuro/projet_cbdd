...
namespace NS_Composants {
	...
	{
		return "SELECT id_commande,date_commande,date_livraison,date_paiement,moyen_paiement,reference_commande,montant_total_ht,montant_total_tva,montant_total_ttc,quantite_article,id_client,id_facture " +
			"FROM Commande;";
	}
	...
	String^ CL_map_TBCOMMANDE::UPDATE(void)
	{
		return "UPDATE Commande " +
			...
			"', reference_commande = '" + this->getreferenceCommande() + "',quantite_article=" + this->getquantite() +
